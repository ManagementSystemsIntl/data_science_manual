...
ggplot(gant2, aes(Date, fct_rev(fct_reorder(Activity,num)), color=Label)) +
  geom_line(size=5) +
#  geom_label(aes(label=Label4)) +
  scale_x_datetime(limits=c(as.POSIXct("2024-03-01"), as.POSIXct("2027-08-01")),
                   date_breaks="6 months",
                   #date_breaks="17 days",
                   date_labels="%b-%y") +
  #, date_labels=c("June 7","21","Jul 5","19","Aug 2","16","30","Sep 13","27","Oct 11")) +
...
# Mapping
>>>>>>> b31fa80429f3e086f421b4b767be9762f15e2ce4
